...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        collisions = pygame.sprite.groupcollide(self.bullets, self.aliens,  False, True) #set 3rd position False if want bullet to not delete
        if collisions:
    ...
    def _create_alien(self, x_position, y_position):
        ...
        new_alien.x = x_position #position as float. Alien left edge placed at end of fleet width
        new_alien.rect.x = x_position # position as int new_alien.rect. Alien left edge placed at end of fleet width
    ...
    def _check_aliens_bottom(self):
         ...
         for alien in self.aliens.sprites():
            if alien.rect.bottom >= self.settings.screen_height:
                # Treat this the same as it the ship got hit.
                self._ship_hit()
                break
